...
{
	console.log("Replace location 1/2");
	location.replace("http://m.omegaserwis.com.pl/wycena");
	console.log("Twój system to: " + getOS());
	console.log("Replace location 2/2");
}
...
<div id="pojemnik">
	...
	<form action="order.php" method="post">
		...
		<a href="https://omegaserwis.com.pl" id="apowrot" style="position: fixed; left: 10px; top: 10px;"><div id="powrot" style=" margin-left: 0px; margin-top: 0px; width: 130px;"> Strona główna </div></a>
	</form>
